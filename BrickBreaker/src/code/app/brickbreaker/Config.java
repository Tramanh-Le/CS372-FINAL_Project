...
/**
 * This class contains all of the application's configuration properties
 */
public final class Config {
    ...
    public static final double BALL_MAX_SPEED = 45; // BRICK_HEIGHT

    public static final double BALL_MIN_COORD_SPEED = 2;

    public static final double BALL_SPEED_INC = 2f;
     ...
     * This constructor prevents other objects from instantiating an instance of this class
     */
    private Config() {
    }
    ...
    /**
     * Retrieve a list of available brick images
     * 
     * @return
     *         List of available brick images
     */
    ...
    /**
     * Retrieve a list of available bonus images
     * 
     * @return
     *         List of available bonus images
     */
    ...
    /**
     * Initialize the configuration parameter values
     */
    public static void initialize() {
        for (final String imageName : IMAGES_NAMES) {
            final Image image = new Image(Config.class.getResourceAsStream(IMAGE_DIR + imageName));
        ...
        for (final String imageName : BRICKS_IMAGES) {
            final String url = IMAGE_DIR + "brick/" + imageName;
            final Image image = new Image(Config.class.getResourceAsStream(url));
        ...
        for (final String imageName : BONUSES_IMAGES) {
